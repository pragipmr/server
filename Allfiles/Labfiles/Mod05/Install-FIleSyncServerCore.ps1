$server = 'SEA-SVR1'
$RG_name = '<replace_with_resource_group_name>'
$FileSync_name = 'FileSync1'


Invoke-Command -ComputerName $server -ArgumentList ($RG_name, $FileSync_name) {
param($RG_name, $FileSync_name)
Install-PackageProvider -Name NuGet -Force; 
Install-Module az.StorageSync -Force;
Start-Process -FilePath "\\SEA-CL1\Labfiles\StorageSyncAgent_WS2019.msi" -ArgumentList "/quiet" -Wait;
Connect-AzAccount -UseDeviceAuthentication; 
Register-AzStorageSyncServer -ResourceGroupName $RG_Name -StorageSyncServiceName $FileSync_name | Out-Null;
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBv4Fu2dpegneG6
# zYpzuEoJr7aMfOEVTGrZMTecXUuMtqCCDYUwggYDMIID66ADAgECAhMzAAABiK9S
...
# +rDOVpE1oknAZ0eJFKnHijr2NsTEUbIGXmjPniLPMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAE9HcROKT976eK1t5ddmYLJYmoTXtIoJTKzQT
# NxcRITZJ1pyl7tqTE55xcxdczYKoYyqvA1Fb3ev3GVQoAZIahEBaJ+vOKGo3Nwt4
# 3i6KCq1C7Lj1uzzOn3WbwXj12Put63SrxA97dkTr1w3lMGWRT2zzUfaP0Vh1epov
# DBlMF6lSM2o3tUkCef+xnE3ewEZp1s24heEQxwVygOwaCNgE0/J3UtuNLH3pczvA
# +NJm3DqzVcfJqpkqLTKcBm17hNIyS6TQ9jmrJqt+FKAF+zIr7ek7G4d1PprI7mXd
# CRL8lb1puMVEzAnQMfJ3J0NNS0aaXCUPO+O6ViCZrK1y+4Esl6GCEvEwghLtBgor
# BgEEAYI3AwMBMYIS3TCCEtkGCSqGSIb3DQEHAqCCEsowghLGAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFVBgsqhkiG9w0BCRABBKCCAUQEggFAMIIBPAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCCcHp0sslDxxQ7OUJKU1WYVbNtV++nZ8LlD
# GjoZTHS+OwIGXvICjyoaGBMyMDIwMDYzMDIwMDAxMS4yNTFaMASAAgH0oIHUpIHR
...
# BQACBQDipbtAMCIYDzIwMjAwNjMwMTcyMzEyWhgPMjAyMDA3MDExNzIzMTJaMHcw
# PQYKKwYBBAGEWQoEATEvMC0wCgIFAOKlu0ACAQAwCgIBAAICK74CAf8wBwIBAAIC
# Ek0wCgIFAOKnDMACAQAwNgYKKwYBBAGEWQoEAjEoMCYwDAYKKwYBBAGEWQoDAqAK
# MAgCAQACAwehIKEKMAgCAQACAwGGoDANBgkqhkiG9w0BAQUFAAOBgQA/Ti6Gzld5
# NXeaVC3VYXkwfHEeWUxSHkLOlFPcHax1fv6ZBtjG6KPvELTVN6D+smw6etlXtQio
# aX5cDbgwC3f9JA82ArNRxkZ4U4mEgf6zOM37GM3SObiNuPLMdQcr7Bsb7YyOpcG7
# j+llzFxRt8ROB+86cQioUN3o/T8o8jTDpDGCAw0wggMJAgEBMIGTMHwxCzAJBgNV
# BAYTAlVTMRMwEQYDVQQIEwpXYXNoaW5ndG9uMRAwDgYDVQQHEwdSZWRtb25kMR4w
# HAYDVQQKExVNaWNyb3NvZnQgQ29ycG9yYXRpb24xJjAkBgNVBAMTHU1pY3Jvc29m
# dCBUaW1lLVN0YW1wIFBDQSAyMDEwAhMzAAABJy9uo++RqBmoAAAAAAEnMA0GCWCG
# SAFlAwQCAQUAoIIBSjAaBgkqhkiG9w0BCQMxDQYLKoZIhvcNAQkQAQQwLwYJKoZI
# hvcNAQkEMSIEIE3+kY6ZxNSKlEbOs5kuD1yi4StxckK9bq2paoyvr2p5MIH6Bgsq
...
# MwAAAScvbqPvkagZqAAAAAABJzAiBCD4AHktsHgqDqOI2qLJHqQgQB0F1NW/pIW/
# 2b1u55seJDANBgkqhkiG9w0BAQsFAASCAQANwgyp25/lsF3ibVsVbPajMBz3LtpE
# jU8LL0LyC2g4mNkkQi4F0ayMYv8ffOsTbhU7nsjai2GaM5vomZyDx64zHlp2SaNL
# 94HzLtbpfYryMr8HuVaU9KQoZBMhifEsGhcmvSlt8gtmkkkqBOfR3KO8zFrr+Jac
# xo2J9p1Ei7gFpp6nDpG71oETTjp2FPYsHh9fV3maZseYjV4kKmWUCPbIB6dB3s+e
# kSeO5pSdpgCGJfGVv13u4J3AmUXPVUUMeSO6nZjqL3V82I+Ftvo0oq6vneyDTXC1
# 5/aSztqiRAleIsCKDt2MZSqGEr3SzcgGZ/6JBCKW+DicZdW6F+c6CZ2O
